...
$.fn.euCookieLawPopup = (function() {
	...
	_self.params = {
		cookiePolicyUrl : 'http://hfcqgis.opendatasicilia.it/it/latest/privacy.html',
		popupPosition : 'top',
		colorStyle : 'default',
		compactStyle : false,
...
$(document).ready( function() {
	if ($(".eupopup").length > 0) {
		$(document).euCookieLawPopup().init({
			...
			'popupTitle' : 'Questo sito, hfcqgis.opendatasicilia.it utilizza i cookie, anche di terze parti, per migliorare la vostra esperienza di navigazione web. <br> ',
